...
bool CLog::Open(string strLogPath, bool bAbsolutePath)
{
	...
	//cout << "---------------------------------------------" << endl;
	//cout << "CAMS :: Opening Log:" << strLogPath.c_str() << endl;
	//cout << "---------------------------------------------" << endl;
...
//--------------------------------------------------------------
// Function		:	WriteLogConsole	
// Description	:	
// Arguments	:	
// Returns		:	true/false
// Note			:	
//--------------------------------------------------------------
bool CLog::WriteLogConsole(const char* szFormat, ...)
{
	if(!m_bOpen)
	{
		return false;
    ...
    m_bConsoleLog = true; // make it write to console
	if(m_bConsoleLog)
	{
		cout << szMessage;
        //cout << szMessage << endl; // we need the newline too
	}
    m_bConsoleLog = false; // make it false to let other write directly in log file instead 
...
//--------------------------------------------------------------
// Function		:	WriteLogWithoutTimeStamp	
// Description	:	
// Arguments	:	
// Returns		:	true/false
// Note			:	
