/***************************************************************************
 ** File            :   fsDEsHash_table.c
 ** 
 ** Description     :   hash implementation
 **
 ** History
 **     Created     :   Nov 5 2012
 **     Modified    :	Nov 15 2012
 **
 ** Notes           :	This is depricated now. hash table 
 **						definition has been moved to "fsDEsHash.c"
 ** ToDo            :
 **
 ***************************************************************************/
...
// #if 0, means we have commented the block
#if 0
fsDEsH->table[0]=166;
fsDEsH->table[1]=223;
fsDEsH->table[2]=187;
